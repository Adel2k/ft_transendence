export function createLoginUI(): HTMLElement {
  ...
  div.className = 'flex items-center justify-center min-h-screen bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 animate-fade-bg';

  div.innerHTML = `
    <div class="bg-gray-800 bg-opacity-90 p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
      ...
      <form id="login-form" class="flex flex-col gap-4">
        ...
        <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded transition duration-300">Login</button>
      </form>
